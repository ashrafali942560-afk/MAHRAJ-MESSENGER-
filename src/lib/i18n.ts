...
export const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    phone_input_label: "Enter Your Gmail Address (EmailJS Gateway)",
    phone_placeholder: "example: name@gmail.com",
    request_otp_btn: "Request Real-Time OTP Verification PIN",
    enter_otp_label: "Enter 6-Digit OTP Protocol PIN",
    otp_placeholder: "6 Digit Code",
    validate_otp_btn: "Verify & Initialize Client",
    resend_otp: "Resend Code",
    change_phone: "Change Email Address",
  ...
  hi: {
    ...
    phone_input_label: "अपना जीमेल पता दर्ज करें (EmailJS गेटवे)",
    phone_placeholder: "उदाहरण: name@gmail.com",
    request_otp_btn: "प्रमाणिक ओटीपी कोड का अनुरोध करें",
    ...
    change_phone: "दूसरा ईमेल दर्ज करें",
  ...
  es: {
    ...
    phone_input_label: "Ingrese su dirección de Gmail (EmailJS Gateway)",
    phone_placeholder: "ejemplo: name@gmail.com",
    request_otp_btn: "Solicitar PIN de verificación en tiempo real",
    ...
    change_phone: "Cambiar dirección de correo",
  ...
  ar: {
    ...
    phone_input_label: "أدخل عنوان الـ Gmail الخاص بك (بوابة EmailJS)",
    phone_placeholder: "مثال: name@gmail.com",
    request_otp_btn: "طلب رمز تحقق OTP فوري للبريد",
    ...
    change_phone: "تغيير البريد الإلكتروني",
